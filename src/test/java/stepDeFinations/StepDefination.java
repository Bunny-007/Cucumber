...
public class StepDefination {
	...
	@When("^WAir For Username$")
	public void wair_For_Username() throws Throwable {
	...
	public void wait_For_Ok() throws Throwable {
		FunctionERP.waitForElement(driver, "xpath", "//*[text()='OK!']","20");
	}

	@When("^Click on OK$")
	public void click_on_OK() throws Throwable {
		FunctionERP.clickAction(driver, "xpath", "//*[text()='OK!']");
	}
